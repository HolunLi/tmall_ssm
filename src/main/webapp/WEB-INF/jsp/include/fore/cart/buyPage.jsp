  ...
  <form action="foreCreateOrder" method="post">
	...
	<div class="productList">
		...
		<table class="productListTable">
			...
			<c:if test="${from == 'cart'}">
				<c:forEach var="orderItem" items="${orderItems}" varStatus="st" >
					<tr class="orderItemTR">
						<td class="orderItemFirstTD"><img class="orderItemImg" src="img/productimage/single_middle/${orderItem.product.firstProductImage.id}.jpg"></td>
		...
		<div class="orderItemSumDiv">
			...
			<span class="pull-right">店铺合计(含运费): ￥<fmt:formatNumber type="number" value="${param.total}" minFractionDigits="2"/></span>
		</div>
	</div>
	...
	<div class="orderItemTotalSumDiv">
		<div class="pull-right"> 
			<span>实付款：</span>
			<span class="orderItemTotalSumSpan">￥<fmt:formatNumber type="number" value="${param.total}" minFractionDigits="2"/></span>
		</div>
	</div>
